<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>@yield('title','Child Development') | VALYNK</title><link rel="stylesheet" href="{{ asset('css/development.css') }}"><script src="{{ asset('js/development.js') }}" defer></script></head>
<body class="{{ isset($wizard) ? 'wizard' : '' }}">
...
@if(isset($wizard))
 <div class="side-intro"><h2>A brighter tomorrow starts here.</h2><p>The right support, at the right time, for your child.</p></div>
